...
def format_bol(doc_name, extracted_data):
    ...
    shipper, consignee, notify, port_of_loading, port_of_discharge, content_description, hs_code = [], [], [], [], [], [], []
    container_id,container_type,package_quantity,gross_weight,seal_number=[],[],[],[],[]
        ...
        for element in data_to_review:
            if element['key'] == 'Header':
                ...
                for element_item in element['value']:
                    ...
                    if element_item['key'] == 'content_description' and element_item['value'] != "":
                        value = remove_leading_trailing_special_characters(element_item['value'])
                        content_description.append(value)
    ...
    df = pd.DataFrame({
                       ...
                       'content_description': pd.Series(content_description),
